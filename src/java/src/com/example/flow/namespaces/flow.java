 ...
 * Source: ../load-dir/flow.fxs
 * BEWARE BEWARE BEWARE BEWARE BEWARE BEWARE BEWARE BEWARE BEWARE
 */

package com.example.flow.namespaces;

import com.tailf.conf.ConfNamespace;

/** Autogenerated namespace class for YANG module flow.yang */
public class flow extends ConfNamespace {
    public static final int hash = 1653571177;
    public int hash() {
        return flow.hash;
    }

    public static final String id = "http://com/example/flow";
    public String id() {
        return flow.id;
    }

    public static final String uri = "http://com/example/flow";
    public String uri() {
        return flow.uri;
    }
    ...
    public static final String _pathType_ = "pathType";
    ...
    public static final String _nodeNum_ = "nodeNum";
    ...
    public static final int    _flowTable = 671048293;
    public static final String _flowTable_ = "flowTable";
    ...
    public static final int    _souDevice = 1405986835;
    public static final String _souDevice_ = "souDevice";
    public static final int    _deviceName = 1173975051;
    public static final String _deviceName_ = "deviceName";
    ...
    public static final String _specificPath_ = "specificPath";
    ...
    public static final int    _optionalPath = 1758523805;
    public static final String _optionalPath_ = "optionalPath";
    ...
    public static final int    _graph = 351735259;
    public static final String _graph_ = "graph";
    ...
    public static final int    _desDevice = 108613908;
    public static final String _desDevice_ = "desDevice";
